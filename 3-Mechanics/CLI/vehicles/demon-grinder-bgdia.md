...
```ad-statblock
title: Demon Grinder
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/vehicles/tokens/BGDIA/Demon%20Grinder.webp#token)
...
**Crushing Wheels** The Demon Grinder can move through the space of any Large or smaller creature. When it does, the creature must succeed on a DC 11 Dexterity saving throw or take 22 (`4d10`) bludgeoning damage and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone). If the creature was already [prone](/2-Mechanics/CLI/rules/conditions.md#prone), it takes an extra 22 (`4d10`) bludgeoning damage. This trait can't be used against a particular creature more than once each turn.
...
**2 Harpoon Flingers (Each Station Requires 1 Crew and Grants Half Cover)** *Ranged Weapon Attack:* `+5` to hit, range 120 ft., one target. *Hit:* 9 (`2d8`) piercing damage.
```
^statblock