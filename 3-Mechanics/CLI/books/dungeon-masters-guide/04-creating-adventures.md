...
![Identify the Party's Goals; Dungeon Goals](/2-Mechanics/CLI/tables/identify-the-partys-goals-dungeon-goals.md)

![Identify the Party's Goals; Wilderness Goals](/2-Mechanics/CLI/tables/identify-the-partys-goals-wilderness-goals.md)

![Identify the Party's Goals; Other Goals](/2-Mechanics/CLI/tables/identify-the-partys-goals-other-goals.md)
...
![Identify Important NPCs; Adventure Villains](/2-Mechanics/CLI/tables/identify-important-npcs-adventure-villains.md)

![Identify Important NPCs; Adventure Allies](/2-Mechanics/CLI/tables/identify-important-npcs-adventure-allies.md)

![Identify Important NPCs; Adventure Patrons](/2-Mechanics/CLI/tables/identify-important-npcs-adventure-patrons.md)
...
![Find the Ideal Introduction; Adventure Introduction](/2-Mechanics/CLI/tables/find-the-ideal-introduction-adventure-introduction.md)
...
![Consider the Ideal Climax; Adventure Climax](/2-Mechanics/CLI/tables/consider-the-ideal-climax-adventure-climax.md)
...
![Determine the Villain's Actions; Event-Based Villain Actions](/2-Mechanics/CLI/tables/determine-the-villains-actions-event-based-villain-actions.md)
...
![Determine the Party's Goals; Event-Based Goals](/2-Mechanics/CLI/tables/determine-the-partys-goals-event-based-goals.md)
...
![Framing Events](/2-Mechanics/CLI/tables/framing-events.md)
...
![Moral Quandaries](/2-Mechanics/CLI/tables/moral-quandaries.md)
...
![Twists](/2-Mechanics/CLI/tables/twists.md)
...
![Side Quests](/2-Mechanics/CLI/tables/side-quests.md)
...
![Combat Encounter Difficulty; XP Thresholds by Character Level](/2-Mechanics/CLI/tables/combat-encounter-difficulty-xp-thresholds-by-character-level.md)
...
![Modify Total XP for Multiple Monsters; Encounter Multipliers](/2-Mechanics/CLI/tables/modify-total-xp-for-multiple-monsters-encounter-multipliers.md)
...
![The Adventuring Day; Adventuring Day XP](/2-Mechanics/CLI/tables/the-adventuring-day-adventuring-day-xp.md)
...
![Sylvan Forest Encounters](/2-Mechanics/CLI/tables/sylvan-forest-encounters.md)
