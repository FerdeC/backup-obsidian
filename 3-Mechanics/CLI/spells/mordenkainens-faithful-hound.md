...
The hound is [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible) to all creatures except you and can't be harmed. When a Small or larger creature comes within 30 feet of it without first speaking the password that you specify when you cast this spell, the hound starts barking loudly. The hound sees [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible) creatures and can see into the Ethereal Plane. It ignores illusions.
