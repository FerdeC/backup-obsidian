...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 7\
    ...
    \ DC 19 Wisdom saving throw or become [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 15 ft., one creature. Hit:\
    \ 3 (1d6) bludgeoning damage. If the target is hit three times by the [rod](/2-Mechanics/CLI/items/tentacle-rod.md)\
...
- "desc": "- Perceive Interlopers. The drow projects her mind throughout her lair,\
    ...
    \ from her and gain no benefit from the [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible)\
    ...
    \ 60 feet of that point must succeed a DC 19 Dexterity saving throw or be [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained)\
