...
- "desc": "The kobold uses one of the following options (choose one or roll a d8);\
    ...
    \ kobold hurls a [flask of acid](/2-Mechanics/CLI/items/acid-vial.md). Ranged\
    ...
    \ fire](/2-Mechanics/CLI/items/alchemists-fire-flask.md). Ranged Weapon Attack:\
    ...
    \ space within 20 feet of it. A [swarm of insects (centipedes)](/2-Mechanics/CLI/bestiary/beast/swarm-of-centipedes.md)\
    ...
    \ off. A target covered in the slime takes 5 (1d10) acid damage at the start\
    \ of each of its turns.  \n- 5 Rot Grub Pot. The kobold throws a clay pot\
    \ into a 5-foot-square space within 20 feet of it, and it breaks open on impact.\
    \ A [swarm of rot grubs](/2-Mechanics/CLI/bestiary/beast/swarm-of-rot-grubs-mpmm.md)\
    \ (in this book) emerges from the shattered pot and remains a hazard in that square.\
    \  \n- 6 Scorpion on a Stick. The kobold makes a melee attack with a [scorpion](/2-Mechanics/CLI/bestiary/beast/scorpion.md)\
    ...
    \ Constitution saving throw, taking 4 (1d8) poison damage on a failed save,\
    \ or half as much damage on a successful one.  \n- 7 Skunk in a Cage. The\
    \ kobold releases a skunk into an unoccupied space within 5 feet of it. The skunk\
    \ has a walking speed of 20 feet, AC 10, 1 hit point, and no effective attacks.\
    \ It rolls initiative and, on its turn, uses its action to spray musk at a random\
    \ creature within 5 feet of it. The target must succeed on a DC 9 Constitution\
    \ saving throw, or it retches and is [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)\
    ...
    \ bag into a 5-foot-square space within 20 feet of it. A [swarm of insects (wasps)](/2-Mechanics/CLI/bestiary/beast/swarm-of-wasps.md)\
