...
- "desc": "The mongrelfolk has one of the following extraordinary features, determined\
    ...
    \ has advantage on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
    ...
    \ start.\n\n20: Two-Headed. The mongrelfolk has advantage on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
...
- "desc": "The mongrelfolk can mimic any sounds it has heard, including voices. A\
    ...
    \ DC 12 Wisdom ([Insight](/2-Mechanics/CLI/rules/skills.md#Insight)) check."
  "name": "Mimicry"
"actions":
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Mongrelfolk.webp"
```
^statblock
