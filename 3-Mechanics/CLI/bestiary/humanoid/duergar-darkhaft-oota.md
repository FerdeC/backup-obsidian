...
- "desc": "The darkhaft's innate spellcasting ability is Intelligence (spell save\
    ...
    \nAt will: [friends](/2-Mechanics/CLI/spells/friends.md), [mage hand](/2-Mechanics/CLI/spells/mage-hand.md)\n\
    \n1/day each: [disguise self](/2-Mechanics/CLI/spells/disguise-self.md), [sleep](/2-Mechanics/CLI/spells/sleep.md)"
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/OotA/Duergar%20Darkhaft.webp"
```
^statblock
