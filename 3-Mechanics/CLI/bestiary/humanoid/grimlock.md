...
SourceType: Bestiary
BookSource: Monster Manual p. 175, Waterdeep: Dungeon of the Mad Mage. Available in the SRD.
---
...
"cr": "1/4"
"traits":
- "desc": "The grimlock can't use its blindsight while [deafened](/2-Mechanics/CLI/rules/conditions.md#deafened)\
    \ and unable to smell."
  "name": "Blind Senses"
- "desc": "The grimlock has advantage on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
    \ checks that rely on hearing or smell."
  "name": "Keen Hearing and Smell"
- "desc": "The grimlock has advantage on Dexterity ([Stealth](/2-Mechanics/CLI/rules/skills.md#Stealth))\
