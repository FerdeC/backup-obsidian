...
- "desc": "The wave shaper's spellcasting ability is Intelligence (spell save DC 14,\
    ...
    \n1/day: [comprehend languages](/2-Mechanics/CLI/spells/comprehend-languages.md)"
...
- "desc": "The wave shaper targets a body of water at least 50 feet square and 25\
    ...
    \ 25 feet tall, and lasts for 1 minute or until the wave shaper is [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated).\
    ...
    \ a DC 14 Strength ([Athletics](/2-Mechanics/CLI/rules/skills.md#Athletics)) check.\n\
    ...
    \ ([Athletics](/2-Mechanics/CLI/rules/skills.md#Athletics)) check to do so.\n\n\
...
"source":
- "GoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/GoS/Sahuagin%20Wave%20Shaper.webp"
```
^statblock
