...
aliases: ["Uthgardt Barbarian Leader"]
NoteIcon: monster
...
```statblock
"name": "Uthgardt Barbarian Leader (SKT)"
"size": "Medium"
"type": "humanoid"
"subtype": "human"
...
- "desc": "Ranged Weapon Attack: +5 to hit, range 150/600 ft., one target. Hit:\
    ...
    \ a sworn enemy See the [oathbow](/2-Mechanics/CLI/items/oathbow.md) entry for\
    \ the other properties."
  "name": "Oathbow"
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Uthgardt%20Barbarian%20Leader.webp"
```
^statblock
