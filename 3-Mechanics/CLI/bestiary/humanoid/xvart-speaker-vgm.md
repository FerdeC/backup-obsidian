...
- "desc": "The xvart can take the Disengage action as a bonus action on each of its\
    \ turns."
  "name": "Low Cunning"
- "desc": "The xvart has advantage on Strength ([Athletics](/2-Mechanics/CLI/rules/skills.md#Athletics))\
    \ checks to shove a creature if at least one of the xvart's allies is within 5\
    \ feet of the target and the ally isn't [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)."
