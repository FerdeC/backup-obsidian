...
- "desc": "The Shard Shunner can use their action to polymorph into a rat-humanoid\
    ...
    \ if they die."
  "name": "Shapechanger"
- "desc": "The Shard Shunner has advantage on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDH/Shard%20Shunner.webp"
```
^statblock
