...
SourceType: Bestiary
BookSource: Monster Manual p. 30, Lost Mine of Phandelver, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Icewind Dale: Rime of the Frostmaiden, Keys from the Golden Vault. Available in the Basic Rules.
---
# [Spectator](2-Mechanics\CLI\bestiary\aberration/spectator.md)
*Source: Monster Manual p. 30, Lost Mine of Phandelver, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Icewind Dale: Rime of the Frostmaiden, Keys from the Golden Vault. Available in the Basic Rules.*  
...
- "desc": "The spectator shoots up to two of the following magical eye rays at one\
    ...
    \ must succeed on a DC 13 Constitution saving throw or be [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed)\
