...
```statblock
"name": "Reduced-Threat Beholder (TftYP)"
"size": "Large"
"type": "aberration"
...
- "desc": "The beholder shoots three of the following magical eye rays at random (reroll\
    ...
    \ The targeted creature must succeed on a DC 14 Constitution saving throw or be\
    ...
    \ on a DC 14 Strength saving throw or the beholder moves it up to 30 feet in any\
    ...
    \ must succeed on a DC 14 Wisdom saving throw or fall asleep and remain [unconscious](/2-Mechanics/CLI/rules/conditions.md#unconscious)\
...
"source":
- "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/TftYP/Reduced-Threat%20Beholder.webp"
```
^statblock
