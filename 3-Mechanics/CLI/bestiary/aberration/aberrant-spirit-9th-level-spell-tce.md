...
---
# [Aberrant Spirit (9th-level Spell)](2-Mechanics\CLI\bestiary\aberration/aberrant-spirit-9th-level-spell-tce.md)
...
- "desc": "At the start of each of the aberration's turns, each creature within 5\
    ...
    \ save DC or take 2d6 psychic damage, provided that the aberration isn't [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)."
...
creatures:
 - 1: Aberrant Spirit (9th-level Spell)
```