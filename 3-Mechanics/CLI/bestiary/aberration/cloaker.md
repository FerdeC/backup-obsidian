...
SourceType: Bestiary
BookSource: Monster Manual p. 41, Princes of the Apocalypse, Waterdeep: Dungeon of the Mad Mage, Journeys through the Radiant Citadel, Keys from the Golden Vault. Available in the SRD.
---
# [Cloaker](2-Mechanics\CLI\bestiary\aberration/cloaker.md)
*Source: Monster Manual p. 41, Princes of the Apocalypse, Waterdeep: Dungeon of the Mad Mage, Journeys through the Radiant Citadel, Keys from the Golden Vault. Available in the SRD.*  
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 10\
    ...
    \ attaches to the target's head, and the target is [blinded](/2-Mechanics/CLI/rules/conditions.md#blinded)\
...
- "VEoR"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/MM/Cloaker.webp"
```
^statblock
