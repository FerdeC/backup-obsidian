...
BestiaryType: undead
SourceType: Bestiary
BookSource: Monster Manual p. 48, Tales from the Yawning Portal, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Icewind Dale: Rime of the Frostmaiden, Journeys through the Radiant Citadel
---
# [Demilich](2-Mechanics\CLI\bestiary\undead/demilich.md)
*Source: Monster Manual p. 48, Tales from the Yawning Portal, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Icewind Dale: Rime of the Frostmaiden, Journeys through the Radiant Citadel*  
...
"condition_immunities": "[charmed](/2-Mechanics/CLI/rules/conditions.md#charmed),\
  ...
  \ [prone](/2-Mechanics/CLI/rules/conditions.md#prone), [stunned](/2-Mechanics/CLI/rules/conditions.md#stunned)"
...
- "desc": "The demilich emits a bloodcurdling howl. Each creature within 30 feet of\
    ...
    \ throw or drop to 0 hit points. On a successful save, the creature is [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "Each creature with in 30 feet of the demilich must make a DC 15 Constitution\
    ...
    \ with the  [greater restoration](/2-Mechanics/CLI/spells/greater-restoration.md)\
...
- "desc": "- The tomb trembles violently for a moment. Each creature on the floor\
    \ of the tomb must succeed on a DC 19 Dexterity saving throw or be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone).\
    \  \n- The demilich targets one creature it can see within 60 feet of it. An [antimagic\
    \ field](/2-Mechanics/CLI/spells/antimagic-field.md) fills the space of the target,\
...
- "desc": "- The first time a non-evil creature enters the tomb's area, the creature\
    ...
    \ or [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened), and against\
