...
- "desc": "The fungal servant is a 10th-level spellcaster. Its spellcasting ability\
    ...
    \n1st level (4 slots): [command](/2-Mechanics/CLI/spells/command.md), [guiding\
    \ bolt](/2-Mechanics/CLI/spells/guiding-bolt.md), [shield of faith](/2-Mechanics/CLI/spells/shield-of-faith.md)\n\
    ...
    \ [divination](/2-Mechanics/CLI/spells/divination.md), [guardian of faith](/2-Mechanics/CLI/spells/guardian-of-faith.md)\n\
    \n5th level (2 slots): [contagion](/2-Mechanics/CLI/spells/contagion.md),\
    \ [insect plague](/2-Mechanics/CLI/spells/insect-plague.md)\n\n6th level (1\
    \ slots): [harm](/2-Mechanics/CLI/spells/harm.md)"
  "name": "Spellcasting"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 14\
    ...
    \ to spores. The curse lasts until removed by the [remove curse](/2-Mechanics/CLI/spells/remove-curse.md)\
...
- "desc": "The fungal servant targets one creature it can see within 60 feet of it.\
    ...
    \ saving throw against this magic or become [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
    \ until the end of the fungal servant's next turn. If the target fails the saving\
    \ throw by 5 or more, it is also [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed)\
...
- "desc": "The fungal servant utters a blasphemous word. Each non-undead creature\
    ...
    \ succeed on a DC 16 Constitution saving throw or be [stunned](/2-Mechanics/CLI/rules/conditions.md#stunned)\
...
- "desc": "The fungal servant magically transforms into a whirlwind of spores, moves\
    ...
    \ fungal servant is immune to all damage, and it can't be [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled),\
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CM/Fungal%20Servant.webp"
```
^statblock
