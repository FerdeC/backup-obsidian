...
BestiaryType: undead
SourceType: Bestiary
BookSource: Monster Manual p. 228, The Rise of Tiamat, Tomb of Annihilation, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Baldur's Gate: Descent Into Avernus, Icewind Dale: Rime of the Frostmaiden, Tasha's Cauldron of Everything, Candlekeep Mysteries, Dragonlance: Shadow of the Dragon Queen. Available in the SRD and the Basic Rules.
---
...
- "desc": "The mummy targets one creature it can see within 60 feet of it. If the\
    ...
    \ this magic or become [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
