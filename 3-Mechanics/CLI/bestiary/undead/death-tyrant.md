...
"cr": "14"
"traits":
- "desc": "The death tyrant's central eye emits an [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible),\
    ...
    \ becomes a [zombie](/2-Mechanics/CLI/bestiary/undead/zombie.md) under the tyrant's\
...
- "desc": "The death tyrant shoots three of the following magical eye rays at random\
    ...
    \ creature must succeed on a DC 17 Wisdom saving throw or be [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success.  \n- 4. Slowing Ray. The\
    ...
    \ in any direction. It is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained)\
    \ by the ray's telekinetic grip until the start of the death tyrant's next turn\
    \ or until the death tyrant is [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated).\
    ...
    \ [unconscious](/2-Mechanics/CLI/rules/conditions.md#unconscious) for 1 minute.\
    ...
    \ failed save, the creature begins to turn to stone and is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained).\
...
- "desc": "- An area that is a 50-foot cube within 120 feet of the tyrant is filled\
    ...
    \ succeed on a DC 17 Dexterity saving throw or be [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled).\
    \ Escaping requires a successful DC 17 Strength ([Athletics](/2-Mechanics/CLI/rules/skills.md#Athletics))\
