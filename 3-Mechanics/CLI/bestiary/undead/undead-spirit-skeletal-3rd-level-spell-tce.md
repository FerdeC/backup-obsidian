...
---
# [Undead Spirit (Skeletal, 3rd-Level Spell)](2-Mechanics\CLI\bestiary\undead/undead-spirit-skeletal-3rd-level-spell-tce.md)
...
- "desc": "Any creature, other than you, that starts its turn within 5 feet of the\
    ...
    \ or be [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned) until the start\
    \ of its next turn."
...
- "desc": "Melee Weapon Attack: the summoner's spell attack modifier to hit, reach\
    ...
    \ or be [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened) of the undead\
...
- "desc": "Melee Weapon Attack: the summoner's spell attack modifier to hit, reach\
    ...
    \ target is [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned), it must\
    \ succeed on a Constitution saving throw against your spell save DC or be [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed)\
...
creatures:
 - 1: Undead Spirit (Skeletal, 3rd-Level Spell)
```