...
"cr": "10"
"traits":
- "desc": "If the dullahan is reduced to 0 hit points, it doesn't die or fall [unconscious](/2-Mechanics/CLI/rules/conditions.md#unconscious).\
    \ Instead, it regains 97 hit points. In addition, it summons three [death's heads](/2-Mechanics/CLI/bestiary/undead/deaths-head-vrgr.md),\
