...
- "desc": "The pit fiend's spellcasting ability is Charisma (spell save DC 21). The\
    ...
    \n3/day each: [hold monster](/2-Mechanics/CLI/spells/hold-monster.md), [wall\
...
- "desc": "Any creature hostile to the pit fiend that starts its turn within 20 feet\
    ...
    \ is [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated). On a\
    \ failed save, the creature is [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "Melee Weapon Attack: +14 to hit, reach 5 ft., one target. Hit: 22\
    ...
    \ the start of each of its turns. The [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
