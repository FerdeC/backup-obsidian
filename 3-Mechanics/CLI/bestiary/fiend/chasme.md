...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 16\
    ...
    \ a long rest or until it is affected by a spell like  [greater restoration](/2-Mechanics/CLI/spells/greater-restoration.md)."
  "name": "Proboscis"
"source":
- "MM"
- "WDMM"
...
- "KftGV"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/MM/Chasme.webp"
```
^statblock
