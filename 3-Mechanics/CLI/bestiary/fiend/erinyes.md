...
> 
> Some erinyes carry a [rope of entanglement](/2-Mechanics/CLI/items/rope-of-entanglement.md) (detailed in the Dungeon Master's Guide). When such an erinyes uses its Multiattack, the erinyes can use the rope in place of two of the attacks.
...
- "desc": "Ranged Weapon Attack: +7 to hit, range 150/600 ft., one target. Hit:\
    ...
    \ The poison lasts until it is removed by the [lesser restoration](/2-Mechanics/CLI/spells/lesser-restoration.md)\
