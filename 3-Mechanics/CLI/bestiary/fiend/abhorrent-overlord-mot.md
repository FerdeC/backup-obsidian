...
- "desc": "The abhorrent overlord's spellcasting ability is Charisma (spell save DC\
    ...
    \n1/day each: [confusion](/2-Mechanics/CLI/spells/confusion.md), [crown of\
    \ madness](/2-Mechanics/CLI/spells/crown-of-madness.md), [suggestion](/2-Mechanics/CLI/spells/suggestion.md)"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 14\
    \ (2d8 + 5) slashing damage plus 14 (4d6) necrotic damage. The abhorrent overlord\
    \ regains hit points equal to half the amount of necrotic damage dealt if the\
...
- "desc": "The abhorrent overlord conjures a swarm of spectral crows and harpies in\
    ...
    \ feet of it. The sphere remains for 1 minute or until the overlord loses [concentration](/2-Mechanics/CLI/rules/conditions.md#concentration)\
    ...
    \ takes 16 (3d10) slashing damage plus 16 (3d10) psychic damage on a failed\
    \ save, or half as much damage on a successful one."
  "name": "Storm of Crows (Recharge 6)"
"source":
- "MOT"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/MOT/Abhorrent%20Overlord.webp"
```
^statblock
