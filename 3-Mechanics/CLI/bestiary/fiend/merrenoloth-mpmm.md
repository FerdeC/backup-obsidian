...
- "desc": "The merrenoloth casts one of the following spells, requiring no material\
    ...
    \ [dispel magic](/2-Mechanics/CLI/spells/dispel-magic.md), [gust of wind](/2-Mechanics/CLI/spells/gust-of-wind.md)\n\
    \n3/day: [control water](/2-Mechanics/CLI/spells/control-water.md)"
  "name": "Spellcasting"
...
- "desc": "The merrenoloth targets one creature it can see within 60 feet of it. The\
    \ target must succeed on a DC 13 Wisdom saving throw or become [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
    \ of the merrenoloth for 1 minute. The [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "- Gale. The air within 60 feet of the vessel is filled with wind. Until\
    ...
    \ there, it must succeed on a DC 13 Strength saving throw or be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone).\
