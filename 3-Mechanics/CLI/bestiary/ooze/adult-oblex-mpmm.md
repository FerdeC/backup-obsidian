...
- "desc": "The oblex casts one of the following spells, requiring no spell components\
    ...
    \ each: [charm person](/2-Mechanics/CLI/spells/charm-person.md) (as 5th-level\
    \ spell), [detect thoughts](/2-Mechanics/CLI/spells/detect-thoughts.md), [hypnotic\
    \ pattern](/2-Mechanics/CLI/spells/hypnotic-pattern.md)"
...
- "desc": "The oblex targets one creature it can see within 5 feet of it. The target\
    ...
    \ attack rolls. Each time the target is memory drained beyond the first, the die\
    \ size increases by one: the d4 becomes a d6, the d6 becomes a d8, and\
    \ so on until the die becomes a d20, at which point the target becomes [unconscious](/2-Mechanics/CLI/rules/conditions.md#unconscious)\
