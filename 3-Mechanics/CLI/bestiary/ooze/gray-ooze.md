...
BestiaryType: ooze
SourceType: Bestiary
BookSource: Monster Manual p. 243, Curse of Strahd, Hoard of the Dragon Queen, Tales from the Yawning Portal, Waterdeep: Dragon Heist, Ghosts of Saltmarsh, Keys from the Golden Vault. Available in the SRD.
---
# [Gray Ooze](2-Mechanics\CLI\bestiary\ooze/gray-ooze.md)
*Source: Monster Manual p. 243, Curse of Strahd, Hoard of the Dragon Queen, Tales from the Yawning Portal, Waterdeep: Dragon Heist, Ghosts of Saltmarsh, Keys from the Golden Vault. Available in the SRD.*  
