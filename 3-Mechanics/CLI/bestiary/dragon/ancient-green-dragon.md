...
- "desc": "- Grasping roots and vines erupt in a 20-foot radius centered on a point\
    ...
    \ saving throw or be [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained)\
    ...
    \ of it. The creature must succeed on a DC 15 Wisdom saving throw or be [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
    \ by the dragon until initiative count 20 on the next round.  "
  "name": ""
- "desc": "At your discretion, a legendary ([adult](/2-Mechanics/CLI/bestiary/dragon/adult-green-dragon.md)\
    \ or [ancient](/2-Mechanics/CLI/bestiary/dragon/ancient-green-dragon.md)) green\
    ...
    \ its lair to animate up to three Humanoid corpses, which become [zombies](/2-Mechanics/CLI/bestiary/undead/zombie.md).\
...
- "SKT"
- "DIP"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/MM/Ancient%20Green%20Dragon.webp"
```
^statblock
