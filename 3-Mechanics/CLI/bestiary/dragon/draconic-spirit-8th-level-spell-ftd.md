...
---
# [Draconic Spirit (8th-level Spell)](2-Mechanics\CLI\bestiary\dragon/draconic-spirit-8th-level-spell-ftd.md)
*Source: Fizban's Treasury of Dragons p. 21*  

```statblock
"name": "Draconic Spirit (8th-level Spell) (FTD)"
"size": "Large"
"type": "dragon"
"alignment": "Neutral"
"ac": !!int "22"
...
"source":
- "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/FTD/Draconic%20Spirit.webp"
```
^statblock

```encounter-table
name: Draconic Spirit (8th-level Spell)
creatures:
 - 1: Draconic Spirit (8th-level Spell)
```