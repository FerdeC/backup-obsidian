...
---
# [Young Amethyst Dragon](2-Mechanics\CLI\bestiary\dragon/young-amethyst-dragon-ftd.md)
...
- "desc": "The dragon casts one of the following spells, requiring no spell components\
    ...
    \ each: [blink](/2-Mechanics/CLI/spells/blink.md), [dispel magic](/2-Mechanics/CLI/spells/dispel-magic.md),\
...
"source":
- "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/FTD/Young%20Amethyst%20Dragon.webp"
```
^statblock
