...
---
# [Draconic Spirit (5th-level Spell)](2-Mechanics\CLI\bestiary\dragon/draconic-spirit-5th-level-spell-ftd.md)
*Source: Fizban's Treasury of Dragons p. 21*  

```statblock
"name": "Draconic Spirit (5th-level Spell) (FTD)"
"size": "Large"
"type": "dragon"
"alignment": "Neutral"
"ac": !!int "19"
...
```encounter-table
name: Draconic Spirit (5th-level Spell)
creatures:
 - 1: Draconic Spirit (5th-level Spell)
```