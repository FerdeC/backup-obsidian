...
- "desc": "Whenever the tomb guardian starts its turn with 40 hit points or fewer,\
    ...
    \ to hear its creator, who must take an action to make a DC 15 Charisma ([Persuasion](/2-Mechanics/CLI/rules/skills.md#Persuasion))\
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/ToA/Spiked%20Tomb%20Guardian.webp"
```
^statblock
