...
---
# [Clockwork Iron Cobra](2-Mechanics\CLI\bestiary\construct/clockwork-iron-cobra-mpmm.md)
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 6 (1d6\
    ...
    \ using whatever weapon it has in hand and moving beforehand if necessary to get\
    \ in range. If it's holding no weapon, it makes an unarmed strike. If no creature\
    \ is visible within 30 feet, it takes the [Dash](/2-Mechanics/CLI/rules/actions.md#Dash)\
    \ action, moving toward the nearest creature.  \n- 3–4 Paralysis. The target\
    \ is [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed) until the end\
