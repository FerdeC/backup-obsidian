...
- "desc": "The giant has a 25% chance chance of having more than one head. If it has\
    \ more than one, it has advantage on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
...
- "desc": "The giant enters a rage. The rage lasts for 1 minute or until the giant\
    \ is [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated). While\
