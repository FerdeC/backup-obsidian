...
- "desc": "The boggle creates a puddle of nonflammable oil. The puddle is 1 inch deep\
    ...
    \ succeed on a DC 11 Dexterity saving throw or fall [prone](/2-Mechanics/CLI/rules/conditions.md#prone).\
    \  \n- Sticky Oil. Any non-boggle creature that enters the puddle or starts\
    \ its turn there must succeed on a DC 11 Strength saving throw or be [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained).\
...
- "desc": "The boggle excretes nonflammable oil from its pores, giving itself one\
    ...
    \n- Slippery Oil. The boggle has advantage on Dexterity ([Acrobatics](/2-Mechanics/CLI/rules/skills.md#Acrobatics))\
    ...
    \ boggle has advantage on Strength ([Athletics](/2-Mechanics/CLI/rules/skills.md#Athletics))\
    ...
    \  "
  "name": "Boggle Oil"
- "desc": "The boggle creates an [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible)\
