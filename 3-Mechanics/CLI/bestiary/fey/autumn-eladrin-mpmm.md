...
- "desc": "The eladrin casts one of the following spells, requiring no material components\
    ...
    \ restoration](/2-Mechanics/CLI/spells/greater-restoration.md), [revivify](/2-Mechanics/CLI/spells/revivify.md)\n\
    \n2/day each: [cure wounds](/2-Mechanics/CLI/spells/cure-wounds.md) (as a\
    \ 5th-level spell), [lesser restoration](/2-Mechanics/CLI/spells/lesser-restoration.md)"
  "name": "Spellcasting"
...
"reactions":
- "desc": "If a creature [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed) by\
