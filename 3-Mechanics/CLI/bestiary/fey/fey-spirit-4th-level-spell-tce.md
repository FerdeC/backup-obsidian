...
---
# [Fey Spirit (4th-level Spell)](2-Mechanics\CLI\bestiary\fey/fey-spirit-4th-level-spell-tce.md)
...
- "desc": "The fey magically teleports up to 30 feet to an unoccupied space it can\
    ...
    \ DC. Unless the save succeeds, the target is [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
