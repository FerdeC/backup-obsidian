...
- "desc": "Any humanoid that starts its turn within 30 feet of the hag and can see\
    ...
    \ the creature is [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10\
  ...
  "name": "Claws"
- "desc": "The hag targets one [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "The hag covers herself and anything she is wearing or carrying with a magical\
    ...
    \ inspect the illusion and succeed on a DC 16 Intelligence ([Investigation](/2-Mechanics/CLI/rules/skills.md#Investigation))\
...
- "desc": "- The hag fills up to four 10-foot cubes of water with ink. The inky areas\
    ...
    \ creates a simulacrum of that creature (as if created with the [simulacrum](/2-Mechanics/CLI/spells/simulacrum.md)\
