...
"cr": "1"
"traits":
- "desc": "Attack rolls against the quickling have disadvantage unless it is [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)\
    \ or its speed is 0."
...
- "desc": "If the quickling is subjected to an effect that allows it to make a Dexterity\
    ...
    \ on the saving throw and only half damage if it fails, provided it isn't [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)."
  "name": "Evasion"
"actions":
