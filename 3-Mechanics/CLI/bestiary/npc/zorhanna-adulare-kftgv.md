...
aliases: ["Zorhanna Adulare"]
NoteIcon: monster
BestiaryType: humanoid (any race)
SourceType: Bestiary
BookSource: Keys from the Golden Vault p. 184
---
# [Zorhanna Adulare](2-Mechanics\CLI\bestiary\npc/zorhanna-adulare-kftgv.md)
*Source: Keys from the Golden Vault p. 184*  

```statblock
"name": "Zorhanna Adulare (KftGV)"
"size": "Medium"
"type": "humanoid"
"subtype": "any race"
...
"cr": "12"
"traits":
- "desc": "Zorhanna Adulare is an 18th-level spellcaster. Its spellcasting ability\
    \ is Intelligence (spell save DC 17, +9 to hit with spell attacks). Zorhanna\
    \ Adulare can cast [disguise self](/2-Mechanics/CLI/spells/disguise-self.md) and\
    \ [invisibility](/2-Mechanics/CLI/spells/invisibility.md) at will and has the\
  ...
  "name": "Spellcasting"
- "desc": "Zorhanna Adulare has advantage on saving throws against spells and other\
    \ magical effects."
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/KftGV/Zorhanna%20Adulare.webp"
```
^statblock
