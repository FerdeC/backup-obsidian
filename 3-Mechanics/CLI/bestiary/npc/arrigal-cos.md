...
---
# [Arrigal](2-Mechanics\CLI\bestiary\npc/arrigal-cos.md)
...
- "desc": "During its first turn, Arrigal has advantage on attack rolls against any\
    \ creature that hasn't taken a turn. Any hit Arrigal scores against a [surprised](/2-Mechanics/CLI/rules/conditions.md#surprised)\
...
- "desc": "Arrigal deals an extra 14 (4d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Arrigal that isn't [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Arrigal.webp"
```
^statblock
