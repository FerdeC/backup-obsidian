...
---
# [Felgolos](2-Mechanics\CLI\bestiary\npc/felgolos-skt.md)
...
"cr": "15"
"traits":
- "desc": "Felgolos can breathe air and water."
  "name": "Amphibious"
- "desc": "If Felgolos fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (3/Day)"
"actions":
- "desc": "Felgolos can use its Frightful Presence. It then makes three attacks: one\
...
- "desc": "Each creature of Felgolos's choice that is within 120 feet of Felgolos\
    ...
    \ is successful or the effect ends for it, the creature is immune to Felgolos's\
...
- "desc": "Felgolos uses one of the following breath weapons.\n\n- Lightning Breath.\
    ...
    \ Breath. Felgolos exhales repulsion energy in a 30-foot cone. Each creature\
    \ in that area must succeed on a DC 19 Strength saving throw. On a failed save,\
    \ the creature is pushed 60 feet away from Felgolos.  "
  "name": "Breath Weapons (Recharge 5-6)"
- "desc": "Felgolos magically polymorphs into a humanoid or beast that has a challenge\
    ...
    \ borne by the new form (Felgolos's choice).\n\nIn a new form, Felgolos retains\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Felgolos makes a Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
- "desc": "Felgolos makes a tail attack."
  "name": "Tail Attack"
- "desc": "Felgolos beats its wings. Each creature within 10 feet of Felgolos must\
    \ succeed on a DC 20 Dexterity saving throw or take 14 (2d6 + 7) bludgeoning\
    \ damage and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone). Felgolos\
    \ can then fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Felgolos.webp"
```
^statblock
