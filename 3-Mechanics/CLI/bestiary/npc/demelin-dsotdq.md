...
---
# [Demelin](2-Mechanics\CLI\bestiary\npc/demelin-dsotdq.md)
...
"cr": "12"
"traits":
- "desc": "Demelin is an 18th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 17, +9 to hit with spell attacks). Demelin can cast [disguise\
  ...
  "name": "Spellcasting"
- "desc": "Demelin has advantage on saving throws against spells and other magical\
    \ effects."
...
"source":
- "DSotDQ"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/DSotDQ/Demelin.webp"
```
^statblock
