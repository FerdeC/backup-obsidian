...
---
# [Zikzokrishka](2-Mechanics\CLI\bestiary\npc/zikzokrishka-cm.md)
...
"legendary_actions":
- "desc": "Zikzokrishka makes a Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Zikzokrishka beats its tattered wings. Each creature within 10 feet of\
    ...
    \ + 7) bludgeoning damage and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone).\
...
- "desc": "- Part of the ceiling collapses above one creature that Zikzokrishka can\
    ...
    \ (6d6) bludgeoning damage and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone)\
    \ and buried under rubble. A buried creature is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained)\
    ...
    \ the cloud must succeed on a DC 15 Constitution saving throw or be [blinded](/2-Mechanics/CLI/rules/conditions.md#blinded)\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CM/Zikzokrishka.webp"
```
^statblock
