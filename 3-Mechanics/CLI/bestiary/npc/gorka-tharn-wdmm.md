...
---
# [Gorka Tharn](2-Mechanics\CLI\bestiary\npc/gorka-tharn-wdmm.md)
...
- "desc": "The mummy lord is a 10th-level spellcaster. Its spellcasting ability is\
    ...
    \ (3 slots): [animate dead](/2-Mechanics/CLI/spells/animate-dead.md), [dispel\
    \ magic](/2-Mechanics/CLI/spells/dispel-magic.md)\n\n4th level (3 slots):\
    \ [stone shape](/2-Mechanics/CLI/spells/stone-shape.md), [guardian of faith](/2-Mechanics/CLI/spells/guardian-of-faith.md)\n\
...
- "desc": "The mummy lord magically turns [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible)\
    \ for up to 1 hour or until it attacks, it casts a spell, it uses its Enlarge,\
    \ or its [concentration](/2-Mechanics/CLI/rules/conditions.md#concentration) is\
    ...
    \ interior. When it awakens, the mummy lord uses a [stone shape](/2-Mechanics/CLI/spells/stone-shape.md)\
...
- "desc": "The mummy lord utters a blasphemous word. Each non-undead creature within\
    ...
    \ a DC 16 Constitution saving throw or be [stunned](/2-Mechanics/CLI/rules/conditions.md#stunned)\
...
- "desc": "The mummy lord magically transforms into a whirlwind of sand, moves up\
    ...
    \ lord is immune to all damage, and it can't be [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled),\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Gorka%20Tharn.webp"
```
^statblock
