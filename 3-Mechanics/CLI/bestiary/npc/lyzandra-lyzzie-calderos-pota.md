...
aliases: ["Lyzandra "Lyzzie" Calderos"]
NoteIcon: monster
BestiaryType: humanoid (human)
SourceType: Bestiary
BookSource: Princes of the Apocalypse p. 110
---
# [Lyzandra "Lyzzie" Calderos](2-Mechanics\CLI\bestiary\npc/lyzandra-lyzzie-calderos-pota.md)
*Source: Princes of the Apocalypse p. 110*  

```statblock
"name": "Lyzandra \"Lyzzie\" Calderos (PotA)"
"size": "Medium"
"type": "humanoid"
"subtype": "human"
...
"cr": "6"
"traits":
- "desc": "Lyzandra is a 9th-level spellcaster. Her spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Lyzandra has the following\
    ...
    \ [immolation](/2-Mechanics/CLI/spells/immolation-xge.md)"
  "name": "Spellcasting"
"actions":
...
"source":
- "PotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/PotA/Lyzandra%20Lyzzie%20Calderos.webp"
```
^statblock
