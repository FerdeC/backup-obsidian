...
---
# [Burney the Barber](2-Mechanics\CLI\bestiary\npc/burney-the-barber-bgdia.md)
...
- "desc": "Burney has the benefits of the [healer](/2-Mechanics/CLI/feats/healer.md)\
    \ feat as well as proficiency with both the [healer's kit](/2-Mechanics/CLI/items/healers-kit.md)\
    \ and the [herbalism kit](/2-Mechanics/CLI/items/herbalism-kit.md)."
  "name": "Healer"
- "desc": "Burney has received several blessings in her service to Bahamut:\n\n- Unless\
    ...
    \ her specifically.  \n- Burney is under the effect of a permanent [mind blank](/2-Mechanics/CLI/spells/mind-blank.md)\
    ...
    \ and can transport herself there as though by a [word of recall](/2-Mechanics/CLI/spells/word-of-recall.md)\
    ...
    \ to the court of Bahamut via a powerful blessing akin to the [plane shift](/2-Mechanics/CLI/spells/plane-shift.md)\
    \ spell.  "
...
- "desc": "Each creature of Burney's choice that is within 120 feet of Burney and\
    \ aware of it must succeed on a DC 19 Wisdom saving throw or become [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "Burney magically polymorphs into a humanoid or beast that has a challenge\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Burney makes a Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Burney beats its wings. Each creature within 15 feet of Burney must succeed\
    ...
    \ and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone). Burney can\
    \ then fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "BGDIA"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/BGDIA/Burney%20the%20Barber.webp"
```
^statblock
