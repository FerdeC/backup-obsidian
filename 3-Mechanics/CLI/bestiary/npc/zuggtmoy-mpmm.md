...
---
# [Zuggtmoy](2-Mechanics\CLI\bestiary\npc/zuggtmoy-mpmm.md)
...
- "desc": "Zuggtmoy casts one of the following spells, requiring no material components\
    ...
    \ [detect magic](/2-Mechanics/CLI/spells/detect-magic.md), [locate animals or\
    \ plants](/2-Mechanics/CLI/spells/locate-animals-or-plants.md)\n\n1/day each:\
    \ [etherealness](/2-Mechanics/CLI/spells/etherealness.md), [teleport](/2-Mechanics/CLI/spells/teleport.md)\n\
    \n3/day each: [dispel magic](/2-Mechanics/CLI/spells/dispel-magic.md), [entangle](/2-Mechanics/CLI/spells/entangle.md),\
...
- "desc": "Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius\
    ...
    \ reanimated as a [spore servant](/2-Mechanics/CLI/bestiary/plant/quaggoth-spore-servant.md)\
...
- "desc": "Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius\
    ...
    \ is [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed) by her and can't\
...
- "desc": "When Zuggtmoy is hit by an attack roll, one creature within 10 feet of\
    \ her that is [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed) by her is\
...
- "desc": "- Rally Plants. Up to four plant creatures that are friendly to Zuggtmoy\
    ...
    \ spores](/2-Mechanics/CLI/bestiary/plant/gas-spore.md) or [violet fungi](/2-Mechanics/CLI/bestiary/plant/violet-fungus.md)\
...
- "desc": "The region containing Zuggtmoy's lair is warped by his magic, creating\
  ...
  "name": ""
- "desc": "- Corrupted Nature. Within 6 miles of the lair, all Wisdom ([Medicine](/2-Mechanics/CLI/rules/skills.md#Medicine))\
