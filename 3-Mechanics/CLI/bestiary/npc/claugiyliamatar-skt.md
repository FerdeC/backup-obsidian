...
---
# [Claugiyliamatar](2-Mechanics\CLI\bestiary\npc/claugiyliamatar-skt.md)
...
- "desc": "Claugiyliamatar casts one of the following spells, requiring no material\
    ...
    \nAt will: [detect magic](/2-Mechanics/CLI/spells/detect-magic.md), [druidcraft](/2-Mechanics/CLI/spells/druidcraft.md),\
    \ [speak with animals](/2-Mechanics/CLI/spells/speak-with-animals.md)\n\n1/day\
    \ each: [blight](/2-Mechanics/CLI/spells/blight.md), [legend lore](/2-Mechanics/CLI/spells/legend-lore.md)\
    \ (cast as 1 action), [locate creature](/2-Mechanics/CLI/spells/locate-creature.md),\
    \ [pass without trace](/2-Mechanics/CLI/spells/pass-without-trace.md), [protection\
    \ from energy](/2-Mechanics/CLI/spells/protection-from-energy.md), [true seeing](/2-Mechanics/CLI/spells/true-seeing.md)\n\
    \n2/day each: [animal messenger](/2-Mechanics/CLI/spells/animal-messenger.md),\
    \ [cure wounds](/2-Mechanics/CLI/spells/cure-wounds.md), [dispel magic](/2-Mechanics/CLI/spells/dispel-magic.md),\
    \ [entangle](/2-Mechanics/CLI/spells/entangle.md), [invisibility](/2-Mechanics/CLI/spells/invisibility.md)"
  "name": "Spellcasting"
