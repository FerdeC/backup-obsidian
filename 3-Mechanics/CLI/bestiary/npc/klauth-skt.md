...
---
# [Klauth](2-Mechanics\CLI\bestiary\npc/klauth-skt.md)
...
- "desc": "Klauth casts one of the following spells, requiring no material components\
    ...
    \ magic](/2-Mechanics/CLI/spells/detect-magic.md), [mage hand](/2-Mechanics/CLI/spells/mage-hand.md),\
    \ [minor illusion](/2-Mechanics/CLI/spells/minor-illusion.md), [prestidigitation](/2-Mechanics/CLI/spells/prestidigitation.md)\n\
    \n1/day each: [banishment](/2-Mechanics/CLI/spells/banishment.md), [cloudkill](/2-Mechanics/CLI/spells/cloudkill.md),\
    \ [disintegrate](/2-Mechanics/CLI/spells/disintegrate.md), [etherealness](/2-Mechanics/CLI/spells/etherealness.md),\
    \ [find the path](/2-Mechanics/CLI/spells/find-the-path.md) (cast as 1 action),\
    \ [greater invisibility](/2-Mechanics/CLI/spells/greater-invisibility.md), [haste](/2-Mechanics/CLI/spells/haste.md),\
    \ [locate object](/2-Mechanics/CLI/spells/locate-object.md), [mass suggestion](/2-Mechanics/CLI/spells/mass-suggestion.md),\
    \ [mirage arcane](/2-Mechanics/CLI/spells/mirage-arcane.md) (cast as 1 action),\
    \ [prismatic spray](/2-Mechanics/CLI/spells/prismatic-spray.md)\n\n2/day each:\
    \ [darkness](/2-Mechanics/CLI/spells/darkness.md), [detect thoughts](/2-Mechanics/CLI/spells/detect-thoughts.md),\
...
- "desc": "Klauth carries a [wand of fireballs](/2-Mechanics/CLI/items/wand-of-fireballs.md)\
    \ and a [wand of lightning bolts](/2-Mechanics/CLI/items/wand-of-lightning-bolts.md),\
    \ and he wears a [ring of cold resistance](/2-Mechanics/CLI/items/ring-of-cold-resistance.md)."
...
- "desc": "Each creature of Klauth's choice that is within 120 feet of Klauth and\
    \ aware of him must succeed on a DC 21 Wisdom saving throw or become [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
"legendary_actions":
- "desc": "Klauth makes a Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Klauth beats his wings. Each creature within 15 feet of Klauth must succeed\
    ...
    \ and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone). Klauth can\
...
- "desc": "- Magma erupts from a point on the ground the dragon can see within 120\
    ...
    \ a DC 13 Constitution saving throw or be [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
    \ until the end of its turn. While [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
    \ in this way, a creature is [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated).\
    \  "
  "name": ""
- "desc": "At your discretion, a legendary ([adult](/2-Mechanics/CLI/bestiary/dragon/adult-red-dragon.md)\
    \ or [ancient](/2-Mechanics/CLI/bestiary/dragon/ancient-red-dragon.md)) red dragon\
    ...
    \ its turn must succeed on a DC 15 Constitution saving throw or be [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Klauth.webp"
```
^statblock
