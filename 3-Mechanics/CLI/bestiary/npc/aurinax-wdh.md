...
---
# [Aurinax](2-Mechanics\CLI\bestiary\npc/aurinax-wdh.md)
...
- "desc": "Each creature of Aurinax's choice that is within 120 feet of Aurinax and\
    \ aware of it must succeed on a DC 21 Wisdom saving throw or become [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "Aurinax magically polymorphs into a humanoid or beast that has a challenge\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Aurinax makes a Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Aurinax beats its wings. Each creature within 10 feet of Aurinax must succeed\
    ...
    \ and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone). Aurinax\
    \ can then fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDH/Aurinax.webp"
```
^statblock
