...
---
# [The Stranger](2-Mechanics\CLI\bestiary\npc/the-stranger-kftgv.md)
*Source: Keys from the Golden Vault p. 173*  

```statblock
"name": "The Stranger (KftGV)"
"size": "Medium"
"type": "humanoid"
"subtype": "any race"
...
"cr": "12"
"traits":
- "desc": "The Stranger is an 18th-level spellcaster. Its spellcasting ability is\
    \ Intelligence (spell save DC 17, +9 to hit with spell attacks). The Stranger\
  ...
  "name": "Spellcasting"
- "desc": "The Stranger wears an invisible [ring of mind shielding](/2-Mechanics/CLI/items/ring-of-mind-shielding.md)\
    \ that thwarts magical attempts to read their thoughts. The Stranger also wears\
    \ [dimensional shackles](/2-Mechanics/CLI/items/dimensional-shackles.md) but is\
    \ eager to be rid of them. One touch from Omid's mace-key causes the shackles\
    \ to fall off, freeing the Stranger."
  "name": "Special Equipment"
- "desc": "The Stranger has advantage on saving throws against spells and other magical\
    \ effects."
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/KftGV/The%20Stranger.webp"
```
^statblock
