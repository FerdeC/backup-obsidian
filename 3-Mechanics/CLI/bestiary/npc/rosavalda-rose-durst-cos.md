...
---
# [Rosavalda "Rose" Durst](2-Mechanics\CLI\bestiary\npc/rosavalda-rose-durst-cos.md)
...
- "desc": "One humanoid that Rose can see within 5 feet of it must succeed on a DC\
    ...
    \ body drops to 0 hit points, Rose ends it as a bonus action, or Rose is turned\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Rosavalda%20Rose%20Durst.webp"
```
^statblock
