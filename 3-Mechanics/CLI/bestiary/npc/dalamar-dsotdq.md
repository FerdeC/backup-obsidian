...
---
# [Dalamar](2-Mechanics\CLI\bestiary\npc/dalamar-dsotdq.md)
...
"cr": "6"
"traits":
- "desc": "Dalamar is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Dalamar has the following\
...
"source":
- "DSotDQ"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/DSotDQ/Dalamar.webp"
```
^statblock
