...
---
# [Talis the White](2-Mechanics\CLI\bestiary\npc/talis-the-white-hotdq.md)
...
"ac": !!int "18"
"ac_class": "[+1 scale mail](/2-Mechanics/CLI/items/1-armor.md), [shield](/2-Mechanics/CLI/items/shield.md)"
"hp": !!int "58"
"hit_dice": "9d8 + 18"
"stats":
- !!int "14"
...
- "desc": "Talis is a 9th-level spellcaster that uses Wisdom as her spellcasting ability\
    \ (spell save DC 14, +6 to hit with spell attacks). Talis has the following\
...
- "HotDQ"
- "ToD"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/HotDQ/Talis%20the%20White.webp"
```
^statblock
