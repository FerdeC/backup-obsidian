...
---
# [Shaldoor](2-Mechanics\CLI\bestiary\npc/shaldoor-skt.md)
...
- "desc": "Shaldoor casts one of the following spells, requiring no material spell\
    ...
    \nAt will: [detect magic](/2-Mechanics/CLI/spells/detect-magic.md), [levitate](/2-Mechanics/CLI/spells/levitate.md),\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Shaldoor.webp"
```
^statblock
