...
---
# [Glyster](2-Mechanics\CLI\bestiary\npc/glyster-wdmm.md)
...
- "desc": "Each creature of Glyster's choice that is within 120 feet of Glyster and\
    \ aware of it must succeed on a DC 17 Wisdom saving throw or become [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "Glyster magically polymorphs into a humanoid or beast that has a challenge\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Glyster makes a Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Glyster beats its wings. Each creature within 10 feet of Glyster must succeed\
    ...
    \ and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone). Glyster\
    \ can then fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Glyster.webp"
```
^statblock
