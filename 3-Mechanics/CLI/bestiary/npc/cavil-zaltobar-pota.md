...
aliases: ["Cavil Zaltobar"]
NoteIcon: monster
BestiaryType: humanoid (human)
SourceType: Bestiary
BookSource: Princes of the Apocalypse p. 182
---
# [Cavil Zaltobar](2-Mechanics\CLI\bestiary\npc/cavil-zaltobar-pota.md)
*Source: Princes of the Apocalypse p. 182*  

```statblock
"name": "Cavil Zaltobar (PotA)"
"size": "Medium"
"type": "humanoid"
"subtype": "human"
...
"cr": "6"
"traits":
- "desc": "Cavil is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Cavil has the following\
...
"source":
- "PotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/PotA/Cavil%20Zaltobar.webp"
```
^statblock
