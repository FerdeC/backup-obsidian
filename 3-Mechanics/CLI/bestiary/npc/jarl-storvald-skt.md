...
- "desc": "Storvald casts one of the following spells, requiring no material components\
    \ and using Wisdom as the spellcasting ability:\n\n1/day each: [jump](/2-Mechanics/CLI/spells/jump.md),\
    \ [locate animals or plants](/2-Mechanics/CLI/spells/locate-animals-or-plants.md),\
    \ [locate object](/2-Mechanics/CLI/spells/locate-object.md), [water breathing](/2-Mechanics/CLI/spells/water-breathing.md),\
    \ [water walk](/2-Mechanics/CLI/spells/water-walk.md)"
  "name": "Spellcasting"
"actions":
- "desc": "Ranged Weapon Attack: +5 to hit, ranged 20/60 ft., one Small, Medium,\
    \ or Large creature. Hit: The target is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained)\
    \ until it escapes the net. Any creature can use its action to make a DC 17 Strength\
    \ check to free itself or another creature in the net, ending the effect on a\
    \ success. Dealing 15 slashing damage to the net (AC 12) destroys the net and\
    \ frees the target."
  "name": "Weighted Net"
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Jarl%20Storvald.webp"
```
^statblock
