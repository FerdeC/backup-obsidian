...
---
# [Hutijin](2-Mechanics\CLI\bestiary\npc/hutijin-mpmm.md)
...
- "desc": "Melee Weapon Attack: +15 to hit, reach 5 ft., one target. Hit: 15\
    ...
    \ throw or become [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned). While\
    ...
    \ of each of its turns. The [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
