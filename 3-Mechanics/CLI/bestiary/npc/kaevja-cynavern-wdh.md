...
"cr": "6"
"traits":
- "desc": "Kaevja is a 9th-level spellcaster. Her spellcasting ability is Intelligence.\
    \ Kaevja has the following wizard spells prepared:\n\nCantrips (at will):\
    ...
    \ [fireball](/2-Mechanics/CLI/spells/fireball.md), [sending](/2-Mechanics/CLI/spells/sending.md)\n\
  ...
  "name": "Spellcasting"
- "desc": "Kaevja carries a yellow [elemental gem](/2-Mechanics/CLI/items/elemental-gem.md).\
    \ As an action she can break the gem releasing an earth elemental under her command."
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDH/Kaevja%20Cynavern.webp"
```
^statblock
