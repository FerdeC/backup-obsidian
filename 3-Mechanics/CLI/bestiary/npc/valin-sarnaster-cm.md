...
---
# [Valin Sarnaster](2-Mechanics\CLI\bestiary\npc/valin-sarnaster-cm.md)
...
- "desc": "- Food instantly molders and water instantly evaporates when brought into\
    ...
    \  \n- [Divination](/2-Mechanics/CLI/spells/divination.md) spells cast within\
    \ the lair by creatures other than Valin have a 25% chance chance to provide misleading\
    \ results, as determined by the DM. If a [divination](/2-Mechanics/CLI/spells/divination.md)\
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CM/Valin%20Sarnaster.webp"
```
^statblock
