...
---
# [Emil Toranescu](2-Mechanics\CLI\bestiary\npc/emil-toranescu-cos.md)
...
- "desc": "Emil can use its action to polymorph into a wolf-humanoid hybrid or into\
  ...
  "name": "Shapechanger"
- "desc": "Emil has advantage on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Emil%20Toranescu.webp"
```
^statblock
