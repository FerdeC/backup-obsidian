...
---
# [Captain Xendros](2-Mechanics\CLI\bestiary\npc/captain-xendros-gos.md)
*Source: Ghosts of Saltmarsh p. 14*  

```statblock
"name": "Captain Xendros (GoS)"
"size": "Medium"
"type": "humanoid"
"subtype": "any race"
...
- "desc": "As a bonus action, Xendros can expend a spell slot to cause its melee weapon\
    ...
    \ a hit. This benefit lasts until the end of the turn. If Xendros expends a spell\
...
"source":
- "GoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/GoS/Captain%20Xendros.webp"
```
^statblock
