...
---
# [Duke Zalto](2-Mechanics\CLI\bestiary\npc/duke-zalto-skt.md)
...
- "desc": "Zalto deals double damage to objects and structures."
  "name": "Siege Monster"
- "desc": "Zalto wears a [ring of lightning resistance](/2-Mechanics/CLI/items/ring-of-lightning-resistance.md)."
  "name": "Special Equipment"
- "desc": "When Zalto enters any enemy's space for the first time on a turn, the enemy\
    \ must succeed on a DC 19 Strength saving throw or be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone)."
  "name": "Tackle"
"actions":
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Duke%20Zalto.webp"
```
^statblock
