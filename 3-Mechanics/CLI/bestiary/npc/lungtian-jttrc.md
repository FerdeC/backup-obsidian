...
---
# [Lungtian](2-Mechanics\CLI\bestiary\npc/lungtian-jttrc.md)
...
- "desc": "Lungtian targets one humanoid or beast that she can see within 30 feet\
    ...
    \ and up to three beasts [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
    \ at a time."
  "name": "Fey Charm"
"source":
- "JttRC"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/JttRC/Lungtian.webp"
```
^statblock
