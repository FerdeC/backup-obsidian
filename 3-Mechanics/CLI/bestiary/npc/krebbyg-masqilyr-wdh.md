...
aliases: ["Krebbyg Masq'il'yr"]
NoteIcon: monster
BestiaryType: humanoid (elf)
SourceType: Bestiary
BookSource: Waterdeep: Dragon Heist p. 67
---
# [Krebbyg Masq'il'yr](2-Mechanics\CLI\bestiary\npc/krebbyg-masqilyr-wdh.md)
...
"cr": "4"
"traits":
- "desc": "Krebbyg's spellcasting ability is Charisma (spell save DC 12) It can innately\
...
- "desc": "Krebbyg has advantage on saving throws against being [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed),\
    \ and magic can't put Krebbyg to sleep."
  "name": "Fey Ancestry"
- "desc": "Being within 5 feet of a hostile creature or attacking at long range doesn't\
    \ impose disadvantage on Krebbyg's ranged attack rolls with a pistol. In addition,\
    \ Krebbyg ignores half cover and three-quarters cover when making ranged attacks\
    \ with a pistol."
  "name": "Gunslinger"
- "desc": "While in sunlight, Krebbyg has disadvantage on attack rolls, as well as\
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDH/Krebbyg%20Masq%27il%27yr.webp"
```
^statblock
