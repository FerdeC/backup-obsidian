...
---
# [Al'chaia](2-Mechanics\CLI\bestiary\npc/alchaia-wdmm.md)
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 13\
    ...
    \ the [astral projection](/2-Mechanics/CLI/spells/astral-projection.md) spell),\
    \ Al'chaia can cut the silvery cord that tethers the target to its material body,\
    \ instead of dealing damage."
  "name": "Silver Greatsword"
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Al%27chaia.webp"
```
^statblock
