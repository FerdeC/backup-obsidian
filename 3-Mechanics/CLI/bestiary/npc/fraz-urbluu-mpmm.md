...
---
# [Fraz-Urb'luu](2-Mechanics\CLI\bestiary\npc/fraz-urbluu-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 129, Mordenkainen's Tome of Foes p. 146*  

Fraz-Urb'luu is the Prince of [Deception](/2-Mechanics/CLI/rules/skills.md#Deception) and Demon Lord of Illusions. He uses every trick, every ounce of demonic cunning, to manipulate his enemies—mortal and Fiend alike—to do his will. Fraz-Urb'luu can create dreamlands and mind-bending fantasies able to deceive the most discerning foes.

Once imprisoned for centuries below Castle Greyhawk on the world of Oerth, Fraz-Urb'luu has slowly rebuilt his power in the Abyss. He seeks the pieces of the legendary [staff of power](/2-Mechanics/CLI/items/staff-of-power.md) taken from him by those who imprisoned him and commands his servants to do likewise.

The Prince of [Deception](/2-Mechanics/CLI/rules/skills.md#Deception)'s true form is like that of a great gargoyle, some 12 feet tall, with an extended, muscular neck; a smiling face framed by long, pointed ears and lank, dark hair; and bat-like wings are furled against his powerful shoulders. He can assume other forms, however, from the hideous to the beautiful.

Many of the cultists of Fraz-Urb'luu aren't even aware they serve the Prince of [Deception](/2-Mechanics/CLI/rules/skills.md#Deception), believing their master is a beneficent being and granter of wishes, some lost god or Celestial, or even another Fiend. Fraz-Urb'luu wears all these masks and more. He particularly delights in aiding demon-hunters against his demonic adversaries, driving the hunters to greater and greater atrocities in the name of their cause, only to eventually reveal his true nature and claim their souls as his own.
...
- "desc": "Fraz-Urb'luu casts one of the following spells, requiring no material components\
    ...
    \ [dispel magic](/2-Mechanics/CLI/spells/dispel-magic.md), [phantasmal force](/2-Mechanics/CLI/spells/phantasmal-force.md)\n\
    \n1/day each: [modify memory](/2-Mechanics/CLI/spells/modify-memory.md), [project\
    \ image](/2-Mechanics/CLI/spells/project-image.md)\n\n3/day each: [mislead](/2-Mechanics/CLI/spells/mislead.md),\
    \ [programmed illusion](/2-Mechanics/CLI/spells/programmed-illusion.md), [seeming](/2-Mechanics/CLI/spells/seeming.md)"
  "name": "Spellcasting"
...
- "desc": "Fraz-Urb'luu targets one creature he can see within 120 feet of him. The\
    ...
    \ psychic damage and is [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
- "desc": "Melee Weapon Attack: +16 to hit, reach 15 ft., one target. Hit: 20\
    ...
    \ is also [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled) (escape DC\
    \ 24), and it is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained)\
...
- "desc": "- Conjure Walls and Doors. Fraz-Urb'luu causes up to five doors within\
    ...
    \ of that creature (as if created with the [simulacrum](/2-Mechanics/CLI/spells/simulacrum.md)\
...
- "desc": "- Beguiling Realm. Within 6 miles of the lair, all Charisma ([Persuasion](/2-Mechanics/CLI/rules/skills.md#Persuasion))\
    \ and Wisdom ([Insight](/2-Mechanics/CLI/rules/skills.md#Insight)) checks have\
    \ disadvantage, and all Charisma ([Deception](/2-Mechanics/CLI/rules/skills.md#Deception))\
