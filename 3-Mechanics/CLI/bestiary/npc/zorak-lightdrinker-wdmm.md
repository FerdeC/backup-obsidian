...
---
# [Zorak Lightdrinker](2-Mechanics\CLI\bestiary\npc/zorak-lightdrinker-wdmm.md)
...
- "desc": "When he drops to 0 hit points outside his resting place, Zorak transforms\
    ...
    \ then [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed) until he regains\
...
- "desc": "Zorak has the following flaws:\n\nForbiddance. Zorak can't enter a residence\
    ...
    \ Zorak is [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)\
    \ in his resting place, Zorak is [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed)\
...
"actions":
- "desc": "Zorak makes two attacks with his [dwarven thrower](/2-Mechanics/CLI/items/dwarven-thrower.md),\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
    ...
    \ by Zorak, [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated),\
...
- "desc": "Zorak targets one humanoid he can see within 30 feet of it. If the target\
    ...
    \ Zorak. The [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed) target regards\
  ...
  "name": "Charm"
- "desc": "Zorak magically calls 2d4 swarms of [bats](/2-Mechanics/CLI/bestiary/beast/swarm-of-bats.md)\
    \ or [rats](/2-Mechanics/CLI/bestiary/beast/swarm-of-rats.md), provided that the\
    \ sun isn't up. While outdoors, Zorak can call 3d6 [wolves](/2-Mechanics/CLI/bestiary/beast/wolf.md)\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Zorak%20Lightdrinker.webp"
```
^statblock
