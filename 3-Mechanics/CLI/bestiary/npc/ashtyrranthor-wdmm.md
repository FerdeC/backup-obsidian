...
---
# [Ashtyrranthor](2-Mechanics\CLI\bestiary\npc/ashtyrranthor-wdmm.md)
...
- "desc": "Ashtyrranthor's spellcasting ability is Charisma. She can innately cast\
    ...
    \ [detect magic](/2-Mechanics/CLI/spells/detect-magic.md), [gaseous form](/2-Mechanics/CLI/spells/gaseous-form.md),\
    \ [misty step](/2-Mechanics/CLI/spells/misty-step.md), [passwall](/2-Mechanics/CLI/spells/passwall.md),\
...
"legendary_actions":
- "desc": "Ashtyrranthor makes a Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Ashtyrranthor beats its wings. Each creature within 10 feet of Ashtyrranthor\
    ...
    \ damage and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone). Ashtyrranthor\
    \ can then fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Ashtyrranthor.webp"
```
^statblock
