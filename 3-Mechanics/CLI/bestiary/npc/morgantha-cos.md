...
---
# [Morgantha](2-Mechanics\CLI\bestiary\npc/morgantha-cos.md)
...
- "desc": "While on the Ethereal Plane, Morgantha magically touches a sleeping humanoid\
    ...
    \ maximum lasts until removed by the  [greater restoration](/2-Mechanics/CLI/spells/greater-restoration.md)\
    \ spell or similar magic."
  "name": "Nightmare Haunting (1/Day)"
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Morgantha.webp"
```
^statblock
