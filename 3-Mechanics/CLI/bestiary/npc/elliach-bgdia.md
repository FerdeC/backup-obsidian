...
---
# [Elliach](2-Mechanics\CLI\bestiary\npc/elliach-bgdia.md)
...
"cr": "6"
"traits":
- "desc": "Elliach is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Elliach has the following\
...
"source":
- "BGDIA"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/BGDIA/Elliach.webp"
```
^statblock
