...
---
# [Kiril Stoyanovich](2-Mechanics\CLI\bestiary\npc/kiril-stoyanovich-cos.md)
...
- "desc": "Kiril can use its action to polymorph into a wolf-humanoid hybrid or into\
  ...
  "name": "Shapechanger"
- "desc": "Kiril has advantage on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Kiril%20Stoyanovich.webp"
```
^statblock
