...
SourceType: Bestiary
BookSource: Dragonlance: Shadow of the Dragon Queen p. 79
---
# [Wyhan](2-Mechanics\CLI\bestiary\npc/wyhan-dsotdq.md)
...
"cr": "6"
"traits":
- "desc": "Wyhan is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Wyhan has the following\
...
"source":
- "DSotDQ"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/DSotDQ/Wyhan.webp"
```
^statblock
