...
---
# [Ludmilla Vilisevic](2-Mechanics\CLI\bestiary\npc/ludmilla-vilisevic-cos.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature,\
    ...
    \ by Ludmilla, [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated),\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Ludmilla%20Vilisevic.webp"
```
^statblock
