...
---
# [Vasilka](2-Mechanics\CLI\bestiary\npc/vasilka-cos.md)
...
- "desc": "Whenever Vasilka starts its turn with 40 hit points or fewer, roll a d6.\
    ...
    \ ([Persuasion](/2-Mechanics/CLI/rules/skills.md#Persuasion)) check. If the check\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Vasilka.webp"
```
^statblock
