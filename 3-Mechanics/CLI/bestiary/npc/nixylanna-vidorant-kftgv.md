...
aliases: ["Nixylanna Vidorant"]
NoteIcon: monster
BestiaryType: humanoid (elf)
SourceType: Bestiary
BookSource: Keys from the Golden Vault p. 130
---
# [Nixylanna Vidorant](2-Mechanics\CLI\bestiary\npc/nixylanna-vidorant-kftgv.md)
*Source: Keys from the Golden Vault p. 130*  

```statblock
"name": "Nixylanna Vidorant (KftGV)"
"size": "Medium"
"type": "humanoid"
"subtype": "elf"
...
- "desc": "If Nixylanna Vidorant is subjected to an effect that allows it to make\
    ...
    \ it fails."
  "name": "Evasion"
- "desc": "Nixylanna Vidorant deals an extra 14 (4d6) damage when it hits a target\
    \ with a weapon attack and has advantage on the attack roll, or when the target\
    \ is within 5 feet of an ally of Nixylanna Vidorant that isn't [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)\
    \ and Nixylanna Vidorant doesn't have disadvantage on the attack roll."
  "name": "Sneak Attack (1/Turn)"
"actions":
- "desc": "Nixylanna Vidorant makes two shortsword attacks."
  "name": "Multiattack"
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/KftGV/Nixylanna%20Vidorant.webp"
```
^statblock
