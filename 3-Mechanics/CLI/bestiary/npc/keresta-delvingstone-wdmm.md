...
---
# [Keresta Delvingstone](2-Mechanics\CLI\bestiary\npc/keresta-delvingstone-wdmm.md)
...
- "desc": "Keresta is a 9th-level spellcaster. Her spellcasting ability is Wisdom\
    ...
    \ [inflict wounds](/2-Mechanics/CLI/spells/inflict-wounds.md), [ray of sickness](/2-Mechanics/CLI/spells/ray-of-sickness.md)\n\
    ...
    \ [animate dead](/2-Mechanics/CLI/spells/animate-dead.md), [bestow curse](/2-Mechanics/CLI/spells/bestow-curse.md),\
    \ [dispel magic](/2-Mechanics/CLI/spells/dispel-magic.md), [spirit guardians](/2-Mechanics/CLI/spells/spirit-guardians.md)\n\
    \n4th level (3 slots): [blight](/2-Mechanics/CLI/spells/blight.md), [death\
    \ ward](/2-Mechanics/CLI/spells/death-ward.md), [divination](/2-Mechanics/CLI/spells/divination.md)\n\
    \n5th level (1 slots): [antilife shell](/2-Mechanics/CLI/spells/antilife-shell.md),\
...
- "desc": "Keresta has the following flaws:\n\nForbiddance. Keresta can't enter\
    ...
    \ heart while Keresta is [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)\
    \ in its resting place, Keresta is [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
    ...
    \ by Keresta, [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated),\
...
- "desc": "Keresta targets one humanoid it can see within 30 feet of it. If the target\
    ...
    \ Keresta. The [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed) target\
...
- "desc": "The vampire magically calls 2d4 swarms of [bats](/2-Mechanics/CLI/bestiary/beast/swarm-of-bats.md)\
    ...
    \ sun isn't up. While outdoors, the vampire can call 3d6 [giant centipedes](/2-Mechanics/CLI/bestiary/beast/giant-centipede.md)\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Keresta%20Delvingstone.webp"
```
^statblock
