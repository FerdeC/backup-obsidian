...
---
# [Nerozar the Defeated](2-Mechanics\CLI\bestiary\npc/nerozar-the-defeated-wdmm.md)
...
- "desc": "The zombie uses a random magical eye ray, choosing a target that it can\
    ...
    \ creature must succeed on a DC 14 Wisdom saving throw or be [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success.  \n- 3. Enervation Ray.\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Nerozar%20the%20Defeated.webp"
```
^statblock
