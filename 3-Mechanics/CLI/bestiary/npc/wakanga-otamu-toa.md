...
---
# [Wakanga O'tamu](2-Mechanics\CLI\bestiary\npc/wakanga-otamu-toa.md)
*Source: Tomb of Annihilation p. 27*  

```statblock
"name": "Wakanga O'tamu (ToA)"
"size": "Medium"
"type": "humanoid"
"subtype": "human"
...
"cr": "6"
"traits":
- "desc": "Wakanga is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Wakanga has the following\
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/ToA/Wakanga%20O%27tamu.webp"
```
^statblock
