...
---
# [Ezzat](2-Mechanics\CLI\bestiary\npc/ezzat-wdmm.md)
...
- "desc": "Ezzat is an 18th-level spellcaster. His spellcasting ability is Intelligence\
  ...
  "name": "Spellcasting"
- "desc": "Ezzat wears an [amulet of proof against detection and location](/2-Mechanics/CLI/items/amulet-of-proof-against-detection-and-location.md)."
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDMM/Ezzat.webp"
```
^statblock
