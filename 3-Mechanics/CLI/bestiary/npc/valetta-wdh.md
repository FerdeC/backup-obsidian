...
---
# [Valetta](2-Mechanics\CLI\bestiary\npc/valetta-wdh.md)
...
- "desc": "Valetta is a 5th-level spellcaster. Her spellcasting ability is Wisdom.\
  ...
  "name": "Spellcasting"
- "desc": "As a bonus action, Valetta can expend a spell slot to cause her melee weapon\
    \ attacks to magically deal an extra 10 (3d6) radiant damage to a target on\
    \ a hit. This benefit lasts until the end of the turn. If Valetta expends a spell\
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/WDH/Valetta.webp"
```
^statblock
