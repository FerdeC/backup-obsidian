...
---
# [Nimuel](2-Mechanics\CLI\bestiary\npc/nimuel-jttrc.md)
...
"cr": "6"
"traits":
- "desc": "Nimuel is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Nimuel has the following\
...
"source":
- "JttRC"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/JttRC/Nimuel.webp"
```
^statblock
