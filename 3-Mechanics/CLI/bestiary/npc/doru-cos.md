...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature,\
    ...
    \ by Doru, [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated),\
    ...
    \ maximum is reduced by an amount equal to the necrotic damage taken, and Doru\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Doru.webp"
```
^statblock
