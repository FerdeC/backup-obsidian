...
---
# [Juiblex](2-Mechanics\CLI\bestiary\npc/juiblex-mpmm.md)
...
- "desc": "Juiblex casts one of the following spells, requiring no material components\
    ...
    \ [detect magic](/2-Mechanics/CLI/spells/detect-magic.md)\n\n3/day each: [contagion](/2-Mechanics/CLI/spells/contagion.md),\
...
- "desc": "Any creature other than an Ooze that starts its turn within 10 feet of\
    \ Juiblex must succeed on a DC 21 Constitution saving throw or be [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "desc": "Juiblex spews out a corrosive slime, targeting one creature that it can\
    ...
    5, the object is destroyed. The penalty on an object can be removed by the [mending](/2-Mechanics/CLI/spells/mending.md)\
    \ spell."
...
- "desc": "Melee Weapon Attack: +14 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ off with an action, the target is [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned),\
    \ and any creature, other than an Ooze, is [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "desc": "On initiative count 20 (losing initiative ties), Juiblex can take one of\
    ...
    \ a row:"
  "name": ""
- "desc": "- Green Slime. A [green slime](/2-Mechanics/CLI/traps-hazards/green-slime.md)\
    ...
    \ on it must succeed on a DC 21 Dexterity saving throw or fall [prone](/2-Mechanics/CLI/rules/conditions.md#prone)\
    ...
    \ there, that creature must make the same save.  \n\n    A [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained)\
    \ creature is stuck as long as it remains in the slimy area or until it breaks\
    \ free. The [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained) creature,\
...
- "desc": "- Acidic Water. Small bodies of water, such as ponds or wells, within\
    ...
    \  \n- Corrupted Nature. Within 6 miles of the lair, all Wisdom ([Medicine](/2-Mechanics/CLI/rules/skills.md#Medicine))\
    \ and Wisdom ([Survival](/2-Mechanics/CLI/rules/skills.md#Survival)) checks have\
