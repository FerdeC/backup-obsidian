...
---
# [Dukha Bhatiyali](2-Mechanics\CLI\bestiary\npc/dukha-bhatiyali-jttrc.md)
...
- "desc": "Dukha can use its action to polymorph into a tiger-humanoid hybrid or into\
  ...
  "name": "Shapechanger"
- "desc": "Dukha has advantage on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
...
- "desc": "If Dukha moves at least 15 feet straight toward a creature and then hits\
    ...
    \ If the target is [prone](/2-Mechanics/CLI/rules/conditions.md#prone), Dukha\
...
"source":
- "JttRC"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/JttRC/Dukha%20Bhatiyali.webp"
```
^statblock
