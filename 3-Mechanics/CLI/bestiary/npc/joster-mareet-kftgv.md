...
---
# [Joster Mareet](2-Mechanics\CLI\bestiary\npc/joster-mareet-kftgv.md)
...
- "desc": "One humanoid Joster Mareet can see within 30 feet of it must succeed on\
    \ a DC 15 Wisdom saving throw or be magically [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
    ...
    \ the next 24 hours.\n\nJoster Mareet can have only one target [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
    \ at a time. If it charms another, the effect on the previous target ends."
  "name": "Charm"
- "desc": "Joster Mareet kisses a creature [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/KftGV/Joster%20Mareet.webp"
```
^statblock
