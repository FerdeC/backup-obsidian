...
---
# [Iskander](2-Mechanics\CLI\bestiary\npc/iskander-rot.md)
...
- "desc": "The mage is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
  ...
  "name": "Spellcasting"
- "desc": "Iskander is presented in The Rise of Tiamat as a neutral evil male human\
    \ wizard. The [mage](/2-Mechanics/CLI/bestiary/humanoid/mage.md) stat block has\
    \ been provided here for ease of use."
  "name": "5etools Note"
"actions":
...
- "RoT"
- "ToD"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/RoT/Iskander.webp"
```
^statblock
