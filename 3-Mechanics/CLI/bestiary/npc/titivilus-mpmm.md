...
---
# [Titivilus](2-Mechanics\CLI\bestiary\npc/titivilus-mpmm.md)
...
- "desc": "Titivilus casts one of the following spells, requiring no material components\
    ...
    \ [nondetection](/2-Mechanics/CLI/spells/nondetection.md), [sending](/2-Mechanics/CLI/spells/sending.md),\
...
- "desc": "Titivilus targets one creature he can see within 10 feet of him. The target\
    \ must succeed on a DC 21 Wisdom saving throw or become [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
    \ of him for 1 minute. While [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
    \ in this way, the target must take the [Dash](/2-Mechanics/CLI/rules/actions.md#Dash)\
    ...
    \ [Dash](/2-Mechanics/CLI/rules/actions.md#Dash) action. The target can repeat\
...
- "desc": "Titivilus targets one creature he can see within 60 feet of him. The target\
    \ must succeed on a DC 21 Charisma saving throw or become [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
    \ by Titivilus for 1 minute. The [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
  ...
  "name": "Twisting Words"
"legendary_actions":
- "desc": "Titivilus uses Twisting Words. Alternatively, he targets one creature [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
    \ by him that is within 60 feet of him; that [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
