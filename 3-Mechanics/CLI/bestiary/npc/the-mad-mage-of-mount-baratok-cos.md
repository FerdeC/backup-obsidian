...
---
# [The Mad Mage of Mount Baratok](2-Mechanics\CLI\bestiary\npc/the-mad-mage-of-mount-baratok-cos.md)
...
- "desc": "The mad mage is an 18th-level spellcaster. His spellcasting ability is\
    ...
    \ [disguise self](/2-Mechanics/CLI/spells/disguise-self.md) and [invisibility](/2-Mechanics/CLI/spells/invisibility.md)\
    ...
    \ slots): [detect magic](/2-Mechanics/CLI/spells/detect-magic.md), [mage armor](/2-Mechanics/CLI/spells/mage-armor.md),\
    \ [magic missile](/2-Mechanics/CLI/spells/magic-missile.md), [shield](/2-Mechanics/CLI/spells/shield.md)\n\
    \n2nd level (3 slots): [mirror image](/2-Mechanics/CLI/spells/mirror-image.md),\
    ...
    \n4th level (3 slots): [Mordenkainen's faithful hound](/2-Mechanics/CLI/spells/mordenkainens-faithful-hound.md),\
    \ [polymorph](/2-Mechanics/CLI/spells/polymorph.md), [stoneskin](/2-Mechanics/CLI/spells/stoneskin.md)\n\
    \n5th level (3 slots): [Bigby's hand](/2-Mechanics/CLI/spells/bigbys-hand.md),\
    \ [cone of cold](/2-Mechanics/CLI/spells/cone-of-cold.md), [scrying](/2-Mechanics/CLI/spells/scrying.md)\n\
    \n6th level (1 slots): [true seeing](/2-Mechanics/CLI/spells/true-seeing.md)\n\
    \n7th level (1 slots): [Mordenkainen's magnificent mansion](/2-Mechanics/CLI/spells/mordenkainens-magnificent-mansion.md)\n\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/The%20Mad%20Mage%20of%20Mount%20Baratok.webp"
```
^statblock
