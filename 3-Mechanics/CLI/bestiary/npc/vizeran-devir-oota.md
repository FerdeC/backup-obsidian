...
aliases: ["Vizeran DeVir"]
NoteIcon: monster
BestiaryType: humanoid (any race)
SourceType: Bestiary
BookSource: Out of the Abyss p. 155
---
# [Vizeran DeVir](2-Mechanics\CLI\bestiary\npc/vizeran-devir-oota.md)
*Source: Out of the Abyss p. 155*  

```statblock
"name": "Vizeran DeVir (OotA)"
"size": "Medium"
"type": "humanoid"
"subtype": "any race"
...
- "desc": "Vizeran is an 18th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 17, +9 to hit with spell attacks). Vizeran can cast [disguise\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/OotA/Vizeran%20DeVir.webp"
```
^statblock
