...
---
# [Ignatius Inkblot](2-Mechanics\CLI\bestiary\npc/ignatius-inkblot-kftgv.md)
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)\
    \ humanoid [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled) by Ignatius\
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/KftGV/Ignatius%20Inkblot.webp"
```
^statblock
