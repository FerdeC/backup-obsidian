...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one target. Hit: 9\
    \ (2d6 + 2) bludgeoning damage, and a Large or smaller target is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "desc": "Grasping roots and vines sprout in a 15-foot radius centered on the blight,\
    ...
    \ or become [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained). A creature\
