...
- "desc": "If a creature starts its turn within 30 feet of the basilisk and the two\
    ...
    \ 10 Constitution saving throw if the basilisk isn't [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated).\
...
"source":
- "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/TftYP/Reduced-Threat%20Basilisk.webp"
```
^statblock
