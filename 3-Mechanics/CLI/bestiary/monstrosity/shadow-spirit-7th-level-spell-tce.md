...
---
# [Shadow Spirit (7th-level Spell)](2-Mechanics\CLI\bestiary\monstrosity/shadow-spirit-7th-level-spell-tce.md)
...
"traits":
- "desc": "The spirit has advantage on attack rolls against [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
    \ creatures."
...
- "desc": "The spirit screams. Each creature within 30 feet of it must succeed on\
    \ a Wisdom saving throw against your spell save DC or be [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
    \ for 1 minute. The [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened)\
...
creatures:
 - 1: Shadow Spirit (7th-level Spell)
```