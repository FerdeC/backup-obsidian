...
- "desc": "The choldrith casts one of the following spells, using Wisdom as the spellcasting\
    ...
    \ [thaumaturgy](/2-Mechanics/CLI/spells/thaumaturgy.md)\n\n1/day each: [bane](/2-Mechanics/CLI/spells/bane.md),\
    \ [hold person](/2-Mechanics/CLI/spells/hold-person.md)"
  "name": "Spellcasting"
- "desc": "The choldrith has advantage on saving throws against being [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed),\
