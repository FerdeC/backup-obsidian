...
- "desc": "Melee Weapon Attack: +11 to hit, reach 5 ft., one target. Hit: 21\
    ...
    \ end of that turn or regurgitate all swallowed creatures, which fall [prone](/2-Mechanics/CLI/rules/conditions.md#prone)\
    \ in a space within 10 feet of the whale. If the whale dies, a swallowed creature\
    \ can escape from the corpse by using 20 feet of movement, exiting [prone](/2-Mechanics/CLI/rules/conditions.md#prone)."
  "name": "Bite"
...
"source":
- "IDRotF"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/IDRotF/Sperm%20Whale.webp"
```
^statblock
