...
- "desc": "If the triceratops moves at least 20 feet straight toward a creature and\
    ...
    \ If the target is [prone](/2-Mechanics/CLI/rules/conditions.md#prone), the triceratops\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 24\
  ...
  "name": "Gore"
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one [prone](/2-Mechanics/CLI/rules/conditions.md#prone)\
