...
- "desc": "On one of its claws, the crab wears a rune-covered copper band that makes\
    \ it immune to being [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed),\
    \ [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened), and [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed).\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 27\
    \ (4d10 + 5) bludgeoning damage, and the target is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled),\
