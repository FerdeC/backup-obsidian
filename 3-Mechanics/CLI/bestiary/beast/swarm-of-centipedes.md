...
- "desc": "Melee Weapon Attack: +3 to hit, reach 0 ft., one target in the swarm's\
    ...
    \ by a swarm of centipedes is stable but [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
    \ for 1 hour, even after regaining hit points, and [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed)\
