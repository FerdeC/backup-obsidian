...
- "desc": "If the deinonychus moves at least 20 feet straight toward a creature and\
    ...
    \ a DC 12 Strength saving throw or be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone).\
    \ If the target is [prone](/2-Mechanics/CLI/rules/conditions.md#prone), the deinonychus\
