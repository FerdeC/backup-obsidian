...
- "desc": "Each creature in the elemental's space must make a DC 15 Strength saving\
    ...
    \ is Large or smaller, it is also [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
    ...
    \ the start of each of the elemental's turns, each target [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
