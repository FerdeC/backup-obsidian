...
- "desc": "The leviathan magically creates a wave of water that extends from a point\
    ...
    \ DC 24 Strength saving throw. On a failed save, a creature takes 45 (7d12)\
    \ bludgeoning damage and is knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone).\
    \ On a successful save, a creature takes half as much damage and isn't knocked\
    \ [prone](/2-Mechanics/CLI/rules/conditions.md#prone). The water spreads out across\
