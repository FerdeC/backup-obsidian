...
- "desc": "The tempest is always at the center of a storm 1d6 + 4 miles in diameter.\
    ...
    \ imposes disadvantage on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception))\
...
- "desc": "Each creature within 120 feet of the tempest must make a DC 21 Dexterity\
    ...
    \ the creature is also [stunned](/2-Mechanics/CLI/rules/conditions.md#stunned)\
...
- "desc": "The tempest releases a blast of thunder and wind in a line that is 300\
    ...
    \ or take the same impact damage and be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone)."
