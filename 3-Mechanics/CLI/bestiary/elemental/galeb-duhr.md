...
SourceType: Bestiary
BookSource: Monster Manual p. 139, Princes of the Apocalypse, Waterdeep: Dungeon of the Mad Mage, Tasha's Cauldron of Everything, The Wild Beyond the Witchlight, Keys from the Golden Vault
---
...
- "desc": "The galeb duhr magically animates up to two boulders it can see within\
    ...
    \ has Intelligence 1 and Charisma 1, it can't be [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed)\
    \ or [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened), and it lacks\
    \ this action option. A boulder remains animated as long as the galeb duhr maintains\
    \ [concentration](/2-Mechanics/CLI/rules/conditions.md#concentration), up to 1\
