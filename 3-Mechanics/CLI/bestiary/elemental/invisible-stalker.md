...
SourceType: Bestiary
BookSource: Monster Manual p. 192, Curse of Strahd, Princes of the Apocalypse, Storm King's Thunder, Tales from the Yawning Portal, Tomb of Annihilation, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Mythic Odysseys of Theros, Icewind Dale: Rime of the Frostmaiden, The Wild Beyond the Witchlight, Keys from the Golden Vault. Available in the SRD.
---
# [Invisible Stalker](2-Mechanics\CLI\bestiary\elemental/invisible-stalker.md)
*Source: Monster Manual p. 192, Curse of Strahd, Princes of the Apocalypse, Storm King's Thunder, Tales from the Yawning Portal, Tomb of Annihilation, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Mythic Odysseys of Theros, Icewind Dale: Rime of the Frostmaiden, The Wild Beyond the Witchlight, Keys from the Golden Vault. Available in the SRD.*  
...
"cr": "6"
"traits":
- "desc": "The stalker is [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible)."
  "name": "Invisibility"
