...
- "desc": "The zaratan exhales rocky debris in a 90-foot cube. Each creature in that\
    \ area must make a DC 25 Dexterity saving throw. A creature takes 33 (6d10)\
    \ bludgeoning damage on a failed save, or half as much damage on a successful\
    \ one. A creature that fails the save by 5 or more is knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone)."
...
- "desc": "After moving at least 10 feet on the ground, the zaratan sends a shock\
    ...
    \ [concentration](/2-Mechanics/CLI/rules/conditions.md#concentration) is broken.\
    ...
    \ 17 (5d6) bludgeoning damage, is knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone),\
    \ and is trapped in the rubble. A trapped creature is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained),\
    \ requiring a successful DC 20 Strength ([Athletics](/2-Mechanics/CLI/rules/skills.md#Athletics))\
    ...
    \ [prone](/2-Mechanics/CLI/rules/conditions.md#prone) or become trapped."
...
- "desc": "The zaratan retracts into its shell. Until it takes its Emerge action,\
    \ it has resistance to all damage, and it is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained).\
